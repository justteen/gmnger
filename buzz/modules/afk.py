...
from buzz.modules.disable import DisableAbleCommandHandler, DisableAbleRegexHandler
from buzz.modules.sql import afk_sql as sql
from buzz.modules.users import get_user_id
