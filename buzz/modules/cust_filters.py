...
from buzz import dispatcher, LOGGER
from buzz.modules.disable import DisableAbleCommandHandler
from buzz.modules.helper_funcs.chat_status import user_admin
from buzz.modules.helper_funcs.extraction import extract_text
from buzz.modules.helper_funcs.filters import CustomFilters
from buzz.modules.helper_funcs.misc import build_keyboard
from buzz.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from buzz.modules.sql import cust_filters_sql as sql

from buzz.modules.translations.strings import tld
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @ossuport for help.")
                        ...
                        try:
                            message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in @ossuport if you can't figure out why!")
