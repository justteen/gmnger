...
# Made by @psycho_syridwan on GitHub and Telegram.
# This module was inspired by Android Helper Bot by Vachounet.
# None of the code is taken from the bot itself, to avoid any more confusion.

LOGGER.info("Original Android Modules by @psycho_syridwan on Telegram")
...
def evo(bot: Bot, update: Update):
    ...
    if device == 'gsi':
        reply_text = """
Please check BUZZ Updates channel! @psycho_syridwan or Click the button down below to download the GSIs!
"""
...
__help__ = """
*This module is made with love by* @psycho_syridwan
 *Device Specific Rom*
