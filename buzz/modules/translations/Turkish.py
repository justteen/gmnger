...
TurkishStrings = {
    "send-start": """Merhaba {}, benim adım {}! Beni nasıl kullanacağın hakkında soruların varsa, /help okuyun @BuzzManagerBot  gidin.

Ben bir [bu kişi](tg://user?id={654839744}) tarafından yönetilen bir grup yönetim botuyum. Bir [BUZZ](https://github.com/justteen/gmnger) forkuyum.
...
[burada](https://github.com/justteen/gmnger) bulabilirsin!

Githubda pull requests göndermekten çekinme, yada destek grubuma, @ossuport'a sorun bildirmek, soru sormak için \
