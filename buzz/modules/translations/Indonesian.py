...
Saya adalah bot manajer grup yang dikelola oleh [orang ini](tg://user?Id={1457097205}). Saya adalah [BUZZ](https://github.com/justteen/gmnger)fork.
...
[disini](https://github.com/justteen/gmnger)))!
