...
EnglishStrings = {
    "send-start": """Hi {}, my name {}! If you have any questions on how to use me, read /help - and then head to @ossuport.

I'm a group manager bot maintained by [this person](tg://user?Id={1457097205}). Saya adalah [BUZZ](https://github.com/justteen/gmnger)) fork.
I'm built in python3, using the \
python-telegram-bot library, and am fully opensource - you can find what makes me tick\
[here](https://github.com/justteen/gmnger)!

Feel free to submit pull requests on github, or to contact my support group, @ossuport, with any bugs, questions \
