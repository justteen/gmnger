...
from buzz import dispatcher, MESSAGE_DUMP, LOGGER
		...
		if note.is_reply:
			...
			try:
				...
				if excp.message == "Entity_mention_user_invalid":
					...
					message.reply_text("This note could not be sent, as it is incorrectly formatted, Please ask in @ossuport if you can't figure out why!")
