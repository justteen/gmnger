...
from buzz import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from buzz.modules import ALL_MODULES
from buzz.modules.helper_funcs.chat_status import is_user_admin
from buzz.modules.helper_funcs.misc import paginate_modules
...
Klik /help untuk bantuan dalam pengoperasian bot.
 ...
 Tambahkan saya ke group. Klik [🤖 disini](http://t.me/MansgergldkBot?startgroup=true).
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("buzz.modules." + module_name)
